...
/**
* Class for the Squirtle Pokemon
...
public class Squirtle extends Pokemon implements Water{
  ...
  */
  ...
  /**
  * Public method that returns Squirtle's special menu
  */
  public String getSpecialMenu(){
    return Water.specialMenu;
  }
  /**
  * Public method that returns the number of the Squirtle's special attacks
  */
  public int getNumSpecialMenuItems(){
    return Water.numSpecialMenuItems;
  }
  /**
  * Public method that enacts Squirtle's special attack
