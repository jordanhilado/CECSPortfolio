...
public class Trainer extends Entity {
  ...
  */
    ...
    double chances = 100.0 - (((double)p.getHp() / p.getMaxHp()) * 100.0);
  ...
  */
  ...
  public void buffAllPokemon() {
    ...
    for (int i = 0; i < pokemon.size(); i++) {
      currentPoke = pokemon.get(i);
      generator.addRandomBuff(currentPoke);
    }
  }
  ...
  public void debuffAllPokemon() {
    ...
    for (int i = 0; i < pokemon.size(); i++) {
      currentPoke = pokemon.get(i);
      generator.addRandomDebuff(currentPoke);
    }
  }
  ...
  */
    ...
    trainerString += "\nMap:\n";
    trainerString += this.map.mapToString(this.getLocation());
    trainerString += "\nMain Menu:\n1. Go North\n2. Go South\n3. Go East\n4. Go West\n5. Quit\n";
